					   ...
					   <!-- user profile -->
						<li class="dropdown user user-menu">
							<a href="" class="dropdown-toggle1" data-toggle="dropdown" >
							   <img src="{{url('/'.auth::user()->profile)}}" class="img-circle" width="25px" height="25px">
							   {{auth::user()->name}}
							</a>
							<ul class="dropdown-menu">
							   <div class="arrow-border"></div>
								<li class="user-header">
									<img src="{{url('/'.auth::user()->profile)}}" class="img-circle">
									<p>  {{auth::user()->name}} </p>
								</li>
								<div class="col-sm-12 groups-management">
									<li class="edite-profile">
										<a href="{{route('dashboard.profile')}}"><span class="fa fa-edit"></span>Edit profile</a>
									</li>
									<li class="sign-out">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu" id="treeopen">
							<li><a  href="{{route('homebackend.index')}}"><i class="fa fa-circle-o"></i>List all Home </a></li>
							<li><a  href="{{route('menu.index')}}"><i class="fa fa-circle-o"></i>List all Menu </a></li>
							<li><a  href="{{route('banner.index')}}"><i class="fa fa-circle-o"></i>List all Banner </a></li>
						</ul>
					</li>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu" id="treeopen">
							<li><a  href="{{route('team.index')}}"><i class="fa fa-circle-o"></i>List all Our Team </a></li>
						</ul>
					</li>
					@endpermission
					<li class="treeview">
						...
						<ul class="treeview-menu" id="treeopen">
							<li><a  href="{{route('post.index')}}"><i class="fa fa-circle-o"></i>List all post </a></li>
						</ul>
					</li>
