...
<head>
    ...
    <title>P&GExpress | @yield('title')</title>
                ...
                <div class="pull-right list-social">
                    <ul>
                       <!--  <li><a href=""><img src="{{asset('front-end/images/icon-phone.png')}}">093322910</a></li>
                        <li><a href="mailto:"><img src="{{asset('front-end/images/icon-email.png')}}">info@pgexpress.biz</a></li>
                        <li><a href="https://www.facebook.com/" target="_blank">Follow Us<img src="{{asset('front-end/images/icon-facebook.png')}}"> </a></li> -->
                        
                        @if (Auth::guest())
                            <!-- <li><a href="{{ route('login') }}">ទូរសព្ទ: ០៨៦​ ៩០០ ៣៩៩ (ស្មាត)</a></li>
                            <li><a href="{{ route('register') }}"></a>០៩២ ២៨០ ២២២ (ស៊ែលកាត)</li> -->
                            <li><a href="">ទូរសព្ទ: ០៨៦​ ៩០០ ៣៩៩</a></li>
                            <li><a href="">០៩២ ២៨០ ២២២</a></li>
                        @else
...
<div class="wrapper">
    <div class="content footer">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="pull-left developed"><span>&copy; <?php echo date('Y');?> P&GExpress. All Rights Reserved. </span></div>
                <div class="pull-right developed"><span>Developed by: <a style="color:#fff;" href="www.pgexpress.biz" target="_blank">www.pgexpress.biz</a></span></div>
            </div>
        </div>
